...
@Component({
  selector: 'app-juego-asociar-frase',
  templateUrl: './juego-asociar-frase.page.html',
  styleUrls: ['./juego-asociar-frase.page.scss'],
})
export class JuegoAsociarFrasePage implements OnInit {  activatedRoute = inject(ActivatedRoute);
...
@ViewChild(IonContent, { static: true }) ionContent: IonContent;
  ...
  ngOnInit() {
    ...
    this.activatedRoute.paramMap.subscribe(params => {
      ...
      this.juegoService.getJuegoUnirFrase(juegoId).subscribe(data => {
