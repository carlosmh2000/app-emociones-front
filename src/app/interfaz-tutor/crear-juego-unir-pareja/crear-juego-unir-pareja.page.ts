...
@Component({
  selector: 'app-crear-juego-unir-pareja',
  templateUrl: './crear-juego-unir-pareja.page.html',
  styleUrls: ['./crear-juego-unir-pareja.page.scss'],
})
export class CrearJuegoUnirParejaPage implements OnInit {
  ...
  public ejercicioTutorial : PreguntaUnirPareja[] = [];
  public audioAcertar = '';
